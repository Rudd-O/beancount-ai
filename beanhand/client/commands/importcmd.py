...
from beanhand.client.beanfiles import (
    FileGuard,
    FileModifiedError,
    insert_document_metadata,
    predict_receipt_destination_path,
)
from beanhand.client.config import (
...
class ImportResult:
    ...
    def commit(self) -> None:
        ...
        # likely place for the user (or another beanhand run) to edit while we
