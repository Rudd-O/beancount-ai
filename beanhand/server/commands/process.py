...
from beanhand.server.storage import make_receipt_backend
from beanhand.structs import AccountRef, check_account_refs
...
def subcommand_parser(
    ...
    process_cmd = sp.add_parser(
        "beanhand.Process", help="Process a receipt image via LLM"
    )
